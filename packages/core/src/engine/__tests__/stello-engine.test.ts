...
describe('StelloEngineImpl', () => {
  ...
  // Task 8: builtin tool injection removed; these tests verify the old auto-inject path.
  // To be deleted in Task 12 (createSessionTool factory).
  describe.skip('stello_create_session 内置拦截', () => {
